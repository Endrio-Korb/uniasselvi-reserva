...
urlpatterns = [
    ...
    path('<int:id>/cancelar', cancelar_form, name='cancelar_form'),
    path('<int:id>/cancelar_reserva', cancelar_reserva, name="cancelar_reserva"),
    ...
    path("<int:id>/editar_form", editar_form, name='editar_form'),
