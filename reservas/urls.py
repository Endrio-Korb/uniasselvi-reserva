...
urlpatterns = [
    ...
    path('r(?P<id>[ 0-9][0-9])/cancelar', cancelar_form, name='cancelar_form'),
    path('r(?P<id>[ 0-9][0-9])/cancelar_reserva', cancelar_reserva, name="cancelar_reserva"),
    ...
    path("r(?P<id>[ 0-9][0-9])/editar_form", editar_form, name='editar_form'),
    path("r(?P<id>[ 0-9][0-9])/editar", editar, name='editar'),
]
